...
Convert a Notion page into a PowerPoint deck with Bun, TypeScript, and PptxGenJS.
...
- Converts the page content into PowerPoint slides through PptxGenJS.
- Optionally writes deck-oriented Markdown for inspection or debugging.
...
1. Install the Playwright Chromium build used for DOCX Mermaid rendering:
...
You can also keep the generated deck markdown:
...
- Notion column layouts are converted into side-by-side PPTX content regions so sibling columns stay on the same slide.
